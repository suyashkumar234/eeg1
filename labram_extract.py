...
LABRAM_CHECKPOINT = "/scratch/suyash.kumar.mec22.itbhu/eeg2/labram_checkpoints/labram-base.pth"
...
OUTPUT_DIR = "labram_features_csv_fold1"
...
class MM_AAD_Dataset(Dataset):
    ...
    def __init__(self, data_path, label_path, subject_ids):
        ...
        # Concatenate all data and maintain proper order
...
def load_labram_base():
    ...
    print(f"Loading LaBraM checkpoint from: {LABRAM_CHECKPOINT}")
    ...
    # Remove student. prefix if exists
    state_dict = {
...
def main():
    ...
    print(f"\nReady for concatenation with DWT features!")
